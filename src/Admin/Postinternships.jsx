...
function Postinternships() {
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div class="mb-10 md:mb-16">
      <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">{t('postJob_Internship:post_a_internship')}</h2>
    ...
    <form class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2" onSubmit={sendData}>
      ...
      <div class="sm:col-span-2">
        <label for="aboutInternship" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">{t('postJob_Internship:aboutInternship')}</label>
      ...
      <div class="sm:col-span-2">
        <label for="stipend" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">{t('postJob_Internship:stipend')}</label>
     ...
     <button  className='hover:bg-blue-600'>{t('postJob_Internship:post_internship')}</button>
    </form>
  </div>
</div>
  )
