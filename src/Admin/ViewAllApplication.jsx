...
function ViewAllApplication() {
    ...
    useEffect(()=>{
        ...
        try {
            const response=await axios.get("https://backend-internarea-bs4w.onrender.com/api/application")
       ...
       <div class="p-4 lg:w-1/2 md:w-full">
         <div class="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col">
           ...
           <div class="flex-grow">
             ...
             <Link to={`/detailApplication?a=${data._id}`} class="mt-3 text-indigo-500 inline-flex items-center">{t('UserApplication:view_in_detail')}
